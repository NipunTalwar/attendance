  ...
  if($result->num_rows > 0) {
    // output data of each row
     ...
     echo '<tr class="tableheader">
      ...
      <td class="hiddenx"><input type='text' value= <?php  echo $row['id'] ?> class='name' name='id'/ style=" width: 0 !important; opacity: 0;
"></td> 
      <td class="text-world">  
      
      <textarea rows='1' name='comment' cols='10' id='comment' placeholder = "Comment Here"> </textarea>   
...
<?php
         ...
         if( $page > 0 ) {
            ...
            echo "<a href = \"$_PHP_SELF?page = $page\">Previous Page</a>";
